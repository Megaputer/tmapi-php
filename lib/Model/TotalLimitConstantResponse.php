...
/**
 * TotalLimitConstantResponse Class Doc Comment
 *
 * @category Class
 * @package  TmApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TotalLimitConstantResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TotalLimitConstantResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ntu'] = isset($data['ntu']) ? $data['ntu'] : null;
    }
     ...
     * @return int|null
     */
    public function getNtu()
    {
        return $this->container['ntu'];
    }

    /**
     * Sets ntu
     *
     * @param int|null $ntu Counter of text units that have been already processed
     *
     * @return $this
     */
    public function setNtu($ntu)
    {
        $this->container['ntu'] = $ntu;
